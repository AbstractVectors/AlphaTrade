   ...
   <div class="container">
      <div class="row">
         <div class="col-md-7 col-sm-7">
            <div class="heading-title text-md-left text-center padding_bottom wow fadeInUp" data-wow-delay="300ms">
         ...
         <div class="col-md-5 col-sm-5 padding_bottom wow fadeInUp" data-wow-delay="350ms">
...
<section id="our-apps" class="bg-apps padding">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="400ms">
...
<section id="our-pricings" class="padding bglight">
   <div class="container">
      ...
      <div class="row three-col-pricing">
         ...
         <div class="col-lg-4 col-sm-12">
            <div class="price-table top60 wow fadeInUp" data-wow-delay="500ms">
               <h3 class="bottom20 darkcolor">Business plan</h3>
               <p>If you are a small business and you are interested in small rebranding then this is a perfect plan for you</p>
               <div class="ammount">
                  <h2 class="defaultcolor"><i class="fa fa-dollar"></i> 29.99 <span class="dur">/ month</span></h2>
...
<section id="our-blog">
   <div class="container">
      <div class="row">
            <div class="col-md-4">
            <div class="news_item shadow text-center wow fadeInUp" data-wow-delay="300ms">
         ...
         <div class="col-md-4">
            <div class="news_item shadow text-center wow fadeInUp" data-wow-delay="350ms">
               <a class="image" href="blog-detail.html">
         ...
         <div class="col-md-4">
            <div class="news_item shadow text-center wow fadeInUp" data-wow-delay="400ms">
               <a class="image" href="blog-detail.html">
                  <img src="images/blog-measonry5.jpg" alt="Latest News" class="img-responsive">
               </a>
               <div class="news_desc">
