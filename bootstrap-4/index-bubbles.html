...
<body data-spy="scroll" data-target=".navbar" data-offset="90" class="particles_special_id">
         ...
         <div class="col-md-8 col-sm-10">
            <div class="text-center banner-center-content padding_half">
               <h2 class="text-capitalize whitecolor font-light top50 bottom35">
                  The Ultimate Creative <span class="block fontbold">Parallax Website</span>
               </h2>
