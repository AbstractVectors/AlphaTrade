         ...
         <div class="collapse navbar-collapse" id="xenav">
            <ul class="navbar-nav ml-auto">
               <li class="nav-item d-none">
                  <a class="nav-link pagescroll active" href="#rev_carousel">Home</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link pagescroll active" href="#rev_carousel">Home</a>
               </li>
...
<!--Main Banner-->
<section class="rotating-words full-screen center-block" id="our-video">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-8 col-sm-10">
            <div class="center-item text-center padding">
               <h2 class="text-capitalize font-xlight top50 bottom35  whitecolor wow fadeInUp" data-wow-delay="400ms">
                  Most Flexible &amp; Creative
                  <span class="block">HTML5 Template</span>
               </h2>
...
<div id="bgndVideo" class="player" data-property="{videoURL:'https://vimeo.com/152362608',containment:'#our-video',autoPlay:true, mute:true, startAt:22, loop:true, opacity:1}">My video</div>   
<!--Main Banner ends-->  
...
<section id="our-apps" class="padding">
   <div class="container">
      ...
      <div class="row" id="app-feature">
         ...
         <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="image feature-item text-center wow fadeInUp" data-wow-delay="500ms">
      ...
      <div class="row">
         ...
         <div class="col-md-6 col-sm-6">
            <div class="split-box text-center center-block equalheight container-padding">
               <div class="heading-title padding_half wow fadeInUp" data-wow-delay="300ms">
