...
<body data-spy="scroll" data-target=".navbar" data-offset="90" class="square-layout">
      ...
      <div class="row">
         ...
         <div class="col-lg-6 nopadding">
            <div class="split-box text-center center-block container-padding equalheight">
               ...
               <a href="#portfolio_top" class="button btnprimary pagescroll wow fadeInUp" data-wow-delay="450ms">Design Works</a>  
            </div>
            </div>
         </div>
      </div>
...
<section id="funfacts" class="padding_top fact-iconic gradient_bg">
   <div class="container text-center">
      <div class="row">
         <div class="col-md-4 col-sm-4 icon-counters whitecolor margin_bottom wow fadeIn" data-wow-delay="350ms">
...
<!-- Background Parallax -->  
<section id="video-parallax" class="video-parallax padding">
   <div class="container">
      <div class="row">
