      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-titles text-center">
               <h2 class="whitecolor font-light bottom30">Counters</h2>
...
<!-- Counters -->  
<section id="funfacts-two" class="padding_top fact-iconic">
...
<!-- Counters -->
<section id="funfacts-three" class="padding bg-counter-light parallaxie">
   <div class="container">
      <div class="row text-center">
         <div class="col-lg-3 col-sm-2 icon-counters darkcolor margin_half">
            <div class="img-icon bottom15">
               <i class="fa fa-smile-o"></i>
            </div>
            <div class="counters">
...
<section id="funfacts-four" class="padding_half fact-iconic gradient_bg">
   <div class="container">
      <div class="row text-center">
         <div class="col-lg-3 col-sm-2 icon-counters whitecolor margin_half">
            <div class="img-icon bottom15">
               <i class="fa fa-smile-o"></i>
            </div>
            <div class="counters">
